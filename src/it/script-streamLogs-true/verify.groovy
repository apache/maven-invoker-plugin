...
assert buildLog.contains('[INFO] [beanshell' + FS + 'pom.xml] Output form beanshell script')
...
assert buildLog.contains('[INFO] [groovy' + FS + 'pom.xml] Output from groovy script')
